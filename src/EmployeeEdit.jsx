                        ...
                        <Container fluid>
                            <form name="employeeUpdate" onSubmit={this.handleSubmit}>
                                ...
                                <Row>
                                    ...
                                    <Col md="auto"><input type="checkbox" name="currentlyEmployed" className="mt-2" defaultChecked={this.state.employee.currentlyEmployed} /></Col>
                                </Row>
                                <Button type="submit" variant="primary" size="sm" className="my-3">Update Employee</Button>
                                <Alert
                                    variant={this.state.alertColor}
                                    show={this.state.alertVisible}
                                    onClose={(e) => this.setState({ alertVisible: false })} dismissible>
